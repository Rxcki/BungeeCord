...
public abstract class ProxyServer
{
     ...
     * @param division the division (style) of the boss bar
     * @return boss bar
     */
    public BossBar createBossBar(BaseComponent[] title, BossBarColor color, BossBarDivision division)
    {
        return createBossBar( title, color, division, 1.0f );
    }
     ...
     * @param color the color of the boss bar
     * @param division the division (style) of the boss bar
     * @param health the health (progress) of the boss bar
     * @return boss bar
     */
    public abstract BossBar createBossBar(BaseComponent[] title, BossBarColor color, BossBarDivision division, float health);
